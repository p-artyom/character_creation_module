"""
Этот модуль выполняет инициализацию персонажа.
Позволяет запустить процесс тренировки персонажа.
"""
...
def attack(char_name: str, char_class: str) -> str:
    """Функция посчёта кол-ва нанесённого урона."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция посчёта кол-ва заблокированного урона."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция запуска процесса тренировки персонажа."""
    if char_class == 'warrior':
